...
public class CbsAdapter implements TransactionAdapter {
        ...
        try {
            ...
            for (int i = 0; i < txNodes.getLength(); i++) {
                ...
                try {
                    ...
                    System.err.println("[CbsAdapter] Skipping row " + i + " — " + ae.getMessage());
                }
            }
            ...
            throw new AdapterException(
                    "CBS XML ingestion failed for [" + filePath + "]: " + e.getMessage(),
    ...
    public IncomingTransaction adapt(Map<String, String> row) throws AdapterException {
        try {
            ...
            SourceSystem sourceSystem = new SourceSystem(sourceSystemId, SourceType.CBS, "");
            ...
            throw new AdapterException(
                    "CBS adapt() failed: " + e.getMessage(), getSourceSystemType(), e);
        }
    }
    ...
    public Map<TransactionType, List<IncomingTransaction>> segregate(
        ...
        System.out.println("[CbsAdapter] Segregation — "
    ...
    private String requireValue(Map<String, String> row, String key) throws AdapterException {
        ...
        if (value == null || value.isBlank()) {
            throw new AdapterException(
                    "Missing required field <" + key + "> in CBS row", getSourceSystemType());
        }
        return value;
    }
