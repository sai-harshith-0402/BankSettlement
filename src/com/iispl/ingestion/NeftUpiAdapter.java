 ...
 * Col 5 — upiId         (String — optional, present only for UPI rows)
 */
public class NeftUpiAdapter implements TransactionAdapter {

    private static final String SOURCE = SourceType.NEFT.name();

    private final SourceSystem sourceSystem;

    public NeftUpiAdapter(SourceSystem sourceSystem) {
