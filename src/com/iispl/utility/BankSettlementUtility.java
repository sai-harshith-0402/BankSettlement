...
public class BankSettlementUtility {
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            switch (choice) {
                case 1: runCrudSection();       break;
                case 2: runOperationsSection(); break;
                case 3:
    ...
    private static void runCrudSection() {
        ...
        while (!back) {
            ...
            switch (choice) {
                case 1: crudBankMenu();        break;
                case 2: crudCustomerMenu();    break;
                case 3: crudAccountMenu();     break;
                case 4: crudTransactionMenu(); break;
    ...
    private static void crudBankMenu() {
        ...
        while (!back) {
            ...
            switch (c) {
                case 1: addBank();          break;
                case 2: viewAllBanks();     break;
                case 3: viewBankById();     break;
                case 4: updateBank();       break;
                case 5: deleteBank();       break;
                case 6: changeBankStatus(); break;
    ...
    private static void addBank() {
        ...
        Bank bank = new Bank(0, LocalDateTime.now(), LocalDateTime.now(),
                code, name, ifsc, active);
    ...
    private static void viewAllBanks() {
        ...
        if (banks.isEmpty()) { System.out.println("[INFO] No banks found."); return; }
    ...
    private static void viewBankById() {
        ...
        if (bank == null) { System.out.println("[WARN] Bank not found for ID " + id); return; }
        printBank(bank);
    }
    ...
    private static void updateBank() {
        ...
        if (existing == null) { System.out.println("[WARN] Bank not found."); return; }
        printBank(existing);
        String  code   = readStringWithDefault("  New Bank Code  [" + existing.getBankCode() + "]: ", existing.getBankCode());
        String  name   = readStringWithDefault("  New Bank Name  [" + existing.getBankName() + "]: ", existing.getBankName());
        String  ifsc   = readStringWithDefault("  New IFSC Code  [" + existing.getIfscCode()  + "]: ", existing.getIfscCode());
        boolean active = readBoolean("  Active? (y/n): ");
    ...
    private static void crudCustomerMenu() {
        ...
        while (!back) {
            ...
            switch (c) {
                ...
                case 3: viewCustomerById();    break;
                case 4: viewCustomerByEmail(); break;
    ...
    private static void addCustomer() {
        ...
        Customer customer = new Customer(0, null, null,
                ...
                LocalDateTime.now(), bankId, active, new ArrayList<>());
    ...
    private static void viewAllCustomers() {
        ...
        if (list.isEmpty()) { System.out.println("[INFO] No customers found."); return; }
    ...
    private static void viewCustomerById() {
        ...
        if (c == null) { System.out.println("[WARN] Customer not found."); return; }
        printCustomer(c);
    }
    ...
    private static void updateCustomer() {
        ...
        if (existing == null) { System.out.println("[WARN] Customer not found."); return; }
    ...
    private static void crudAccountMenu() {
        ...
        while (!back) {
            ...
            switch (c) {
                ...
                case 3:  viewAccountById();          break;
                case 4:  viewAccountByNumber();      break;
                case 5:  viewAccountsByCustomerId(); break;
                case 6:  viewAccountsByBankId();     break;
                case 7:  updateAccount();            break;
                case 8:  updateAccountBalance();     break;
                case 9:  updateAccountStatus();      break;
    ...
    private static void addAccount() {
        ...
        Account acc = new Account(0, LocalDateTime.now(), LocalDateTime.now(),
                custId, accNum, type, bankId, bal, status);
    ...
    private static void viewAllAccounts() {
        ...
        if (list.isEmpty()) { System.out.println("[INFO] No accounts found."); return; }
        System.out.println("[INFO] Total: " + list.size());
    ...
    private static void viewAccountById() {
        ...
        if (a == null) { System.out.println("[WARN] Account not found."); return; }
        printAccount(a);
    }
    ...
    private static void viewAccountsByCustomerId() {
        ...
        if (list.isEmpty()) { System.out.println("[INFO] No accounts for this customer."); return; }
        list.forEach(BankSettlementUtility::printAccount);
    }
    ...
    private static void viewAccountsByBankId() {
        ...
        if (list.isEmpty()) { System.out.println("[INFO] No accounts for this bank."); return; }
        list.forEach(BankSettlementUtility::printAccount);
    }
    ...
    private static void updateAccount() {
        ...
        if (existing == null) { System.out.println("[WARN] Account not found."); return; }
    ...
    private static void crudTransactionMenu() {
        ...
        while (!back) {
            ...
            switch (c) {
                ...
                case 2: viewTransactionById();            break;
                case 3: viewTransactionsBySourceSystem(); break;
                case 4: viewTransactionsByStatus();       break;
                case 5: updateTransactionBatchId();       break;
    ...
    private static void viewAllTransactions() {
        ...
        if (list.isEmpty()) { System.out.println("[INFO] No transactions found."); return; }
        System.out.println("[INFO] Total: " + list.size());
    ...
    private static void viewTransactionById() {
        ...
        if (txn == null) { System.out.println("[WARN] Transaction not found."); return; }
    ...
    private static void viewTransactionsByStatus() {
        ...
        ProcessingStatus ps;
        try { ps = ProcessingStatus.valueOf(input.toUpperCase()); }
        catch (IllegalArgumentException e) { System.out.println("[ERROR] Invalid status."); return; }
        List<IncomingTransaction> list = transactionDao.findByProcessingStatus(ps);
        if (list.isEmpty()) { System.out.println("[INFO] No transactions with status " + ps); return; }
        list.forEach(BankSettlementUtility::printTransaction);
    }
    ...
    private static void runOperationsSection() {
        ...
        while (!back) {
            ...
            int choice = readInt("Enter choice: ");
            switch (choice) {
                case 1:  opsCreateBatch();           break;
                case 2:  opsViewAllBatches();        break;
                case 3:  opsViewBatchesByStatus();   break;
                case 4:  opsCreateSettlement();      break;
                case 5:  opsViewAllSettlements();    break;
                case 6:  opsRunNetting();             break;
                case 7:  opsViewAllNetting();         break;
                case 8:  opsRunReconciliation();      break;
                case 9:  opsViewAllReconciliation();  break;
    ...
    private static void opsCreateBatch() {
        ...
        for (SourceSystem ss : sources) {
            System.out.println("[INFO] Source: " + ss.getSourceType()
                    + " | File: " + ss.getFilePath());
            try {
                ...
                System.out.println("[ERROR] Adapter failed for " + ss.getSourceType()
                        + ": " + e.getMessage());
            }
        }
    ...
    private static void opsViewAllBatches() {
        ...
        if (batches.isEmpty()) { System.out.println("[INFO] No batches in DB."); return; }
    ...
    private static void opsViewBatchesByStatus() {
        ...
        String input = readString("  Enter Status: ");
        BatchStatus status;
        try { status = BatchStatus.valueOf(input.toUpperCase()); }
        catch (IllegalArgumentException e) { System.out.println("[ERROR] Invalid status."); return; }
    ...
    private static void opsViewAllSettlements() {
        ...
        if (results.isEmpty()) { System.out.println("[INFO] No settlement records in DB."); return; }
    ...
    private static void opsRunNetting() {
        ...
        for (Batch batch : completed) {
            ...
            try {
                ...
                System.out.println("[ERROR] Netting failed for " + batch.getBatchId()
                        + ": " + e.getMessage());
            }
        }
    ...
    private static void opsViewAllNetting() {
        ...
        if (list.isEmpty()) { System.out.println("[INFO] No netting positions in DB."); return; }
        System.out.println("[INFO] Total: " + list.size());
    ...
    private static void opsRunReconciliation() {
        ...
        for (Batch batch : completed) {
            ...
            try {
                ...
                System.out.println("[ERROR] Reconciliation failed for " + batch.getBatchId()
                        + ": " + e.getMessage());
            }
        }
    ...
    private static void opsViewAllReconciliation() {
        ...
        if (entries.isEmpty()) { System.out.println("[INFO] No reconciliation entries in DB."); return; }
    ...
    private static AccountType readAccountType() {
        ...
        while (true) {
            ...
            try { return AccountType.valueOf(scanner.nextLine().trim().toUpperCase()); }
            catch (IllegalArgumentException e) {
                System.out.println("[ERROR] Invalid type. Choose from: "
